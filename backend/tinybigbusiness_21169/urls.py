"""tinybigbusiness_21169 URL Configuration
...
admin.site.site_header = "TinyBIGBusiness"
admin.site.site_title = "TinyBIGBusiness Admin Portal"
admin.site.index_title = "TinyBIGBusiness Admin"

# swagger
api_info = openapi.Info(
    title="TinyBIGBusiness API",
    default_version="v1",
    description="API documentation for TinyBIGBusiness App",
)
